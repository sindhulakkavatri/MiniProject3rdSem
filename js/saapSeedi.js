...
(function(w, d) {
    function board(width, height) {
        ...
        this.config = {
           ...
           // ladders: [{s: 8,e: 49}, {s: 22,e: 57}, {s: 54,e: 85}, {s: 61,e: 98}]
			colors: ["red", "blue", "green","pink","yellow","#BDB76B","gray","#006400","white","#87CEEB"],
			snakeLadderLayer: "images/snake_ladder_layer.gif",
    ...
    var player = function(board, id, name, color) {
        ...
        this.id = id;
        this.name = name;
        this.color = color;//changed color to "black"
        this.position = 1;
    }
    ...
    p.placeGoti = function(position) {
        ...
        var gotiY = blockY + (0.9 * blockH) - gotiR;//changed from 0.9 tp 1.5
